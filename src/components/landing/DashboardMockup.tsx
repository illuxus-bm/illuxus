  ...
  return (
    <div className="relative mx-auto w-full max-w-[920px]">
      ...
      >
        ...
        >
          <div className="relative w-[260px] rounded-2xl border border-white/10 bg-[#111114]/95 p-4 shadow-[0_20px_60px_-10px_rgba(0,0,0,0.6)] backdrop-blur-xl">
            <div className="flex items-start gap-3">
              ...
              <span className="ml-2 inline-flex items-center gap-1 rounded-full bg-emerald-400/10 px-1.5 py-0.5 text-[10px] font-medium text-emerald-300 ring-1 ring-inset ring-emerald-400/20">
      ...
      >
        <motion.div
          ...
          className="motion-reduce:!transform-none"
        >
          <div className="relative w-[240px] rounded-2xl border border-white/10 bg-[#111114]/95 p-4 shadow-[0_20px_60px_-10px_rgba(0,0,0,0.6)] backdrop-blur-xl">
            <div className="flex items-start gap-3">
            ...
            <div className="mt-3 flex items-center justify-between rounded-lg bg-white/[0.04] px-2.5 py-1.5">
              <span className="text-[10px] text-white/50">Capacity</span>
      ...
      <motion.div
        ...
        className="relative z-10 overflow-hidden rounded-2xl border border-white/10 bg-[#0E0E12] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.75)]"
      >
        {/* Window chrome */}
        <div className="flex items-center justify-between border-b border-white/[0.06] bg-white/[0.02] px-4 py-2.5">
          ...
          <div className="hidden items-center gap-1.5 rounded-md bg-white/[0.04] px-2.5 py-1 text-[10px] text-white/45 sm:flex">
        ...
        <div className="grid grid-cols-12 gap-0">
          {/* Sidebar */}
          <aside className="col-span-3 hidden border-r border-white/[0.06] p-4 md:block">
          ...
          <main className="col-span-12 p-5 md:col-span-9 md:p-6">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div
                        className={`flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br ${stat.tint} ring-1 ring-white/10`}
                      >
            ...
            <div className="mt-4 rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
              <div className="mb-3 flex items-center justify-between">
                ...
                <span className="text-[10px] text-white/40">Last 4 hours</span>
              </div>
              <svg
                viewBox="0 0 400 100"
