...
export const THEME_PRESETS: ThemePreset[] = [
  { id: "indigo-classic", name: "Indigo Classic", theme: { primaryColor: "#6366f1", accentColor: "#f59e0b", backgroundColor: "#ffffff", textColor: "#1a1a2e", fontFamily: "Inter" } },
  { id: "midnight-blue",   name: "Midnight Blue",   theme: { primaryColor: "#3b82f6", accentColor: "#22d3ee", backgroundColor: "#0b1120", textColor: "#e2e8f0", fontFamily: "Inter" } },
  { id: "forest",          name: "Forest",          theme: { primaryColor: "#16a34a", accentColor: "#facc15", backgroundColor: "#f7faf7", textColor: "#0f1f14", fontFamily: "Inter" } },
  ...
  { id: "ocean",           name: "Ocean",           theme: { primaryColor: "#0ea5e9", accentColor: "#14b8a6", backgroundColor: "#f0f9ff", textColor: "#0c2733", fontFamily: "Inter" } },
  ...
  { id: "emerald",         name: "Emerald",         theme: { primaryColor: "#10b981", accentColor: "#fbbf24", backgroundColor: "#ffffff", textColor: "#0a1f1a", fontFamily: "Inter" } },
  { id: "monochrome",      name: "Monochrome",      theme: { primaryColor: "#0a0a0a", accentColor: "#525252", backgroundColor: "#fafafa", textColor: "#0a0a0a", fontFamily: "Inter" } },
  { id: "carbon",          name: "Carbon",          theme: { primaryColor: "#fafafa", accentColor: "#facc15", backgroundColor: "#0a0a0a", textColor: "#fafafa", fontFamily: "Inter" } },
  ...
  { id: "sky-mint",        name: "Sky Mint",        theme: { primaryColor: "#06b6d4", accentColor: "#10b981", backgroundColor: "#f0fdfa", textColor: "#0c2723", fontFamily: "Inter" } },
  ...
  { id: "slate-pro",       name: "Slate Pro",       theme: { primaryColor: "#475569", accentColor: "#0ea5e9", backgroundColor: "#f8fafc", textColor: "#0f172a", fontFamily: "Inter" } },
  ...
  { id: "arctic",          name: "Arctic",          theme: { primaryColor: "#0369a1", accentColor: "#64748b", backgroundColor: "#f0f9ff", textColor: "#0c1827", fontFamily: "Inter" } },
];
...
export const FONT_OPTIONS: string[] = [
  "Inter", "Poppins", "Playfair Display", "Merriweather",
