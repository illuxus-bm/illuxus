...
export const defaultDesign = (): BadgeDesign => ({
  ...
  fullBleed: true,
  elements: {
    name:        { enabled: true,  x: 50, y: 42, size: 22, color: "#111111", fontFamily: "Poppins",        fontWeight: 700, align: "center", transform: "none",      letterSpacing: -0.01, lineHeight: 1.1 },
    company:     { enabled: true,  x: 50, y: 56, size: 12, color: "#555555", fontFamily: "Poppins",        fontWeight: 400, align: "center", transform: "none",      letterSpacing: 0,     lineHeight: 1.2 },
    ...
    orgName:     { enabled: false, x: 50, y: 8,  size: 8,  color: "#64748b", fontFamily: "Poppins",        fontWeight: 600, align: "center", transform: "uppercase", letterSpacing: 0.18,  lineHeight: 1.2 },
...
export const LAYOUT_PRESETS: LayoutPreset[] = [
  {
    ...
    elements: {
      name:    { enabled: true,  x: 50, y: 42, size: 22, fontFamily: "Poppins",       fontWeight: 700, color: "#111111", align: "center", transform: "none" },
      company: { enabled: true,  x: 50, y: 56, size: 12, fontFamily: "Poppins",       fontWeight: 400, color: "#555555", align: "center", transform: "none" },
  ...
  },
  {
    ...
    elements: {
      name:    { enabled: true,  x: 50, y: 32, size: 28, fontFamily: "Poppins",       fontWeight: 800, color: "#000000", align: "center", transform: "none", letterSpacing: -0.02 },
  ...
  },
  {
    ...
    elements: {
      ticket:  { enabled: true,  x: 50, y: 14, size: 9,  fontFamily: "Poppins",       fontWeight: 800, color: "#ffffff", align: "center", transform: "uppercase", letterSpacing: 0.16, staticText: "SPEAKER" },
      name:    { enabled: true,  x: 50, y: 35, size: 24, fontFamily: "Plus Jakarta Sans", fontWeight: 700, color: "#111111", align: "center" },
      title:   { enabled: true,  x: 50, y: 46, size: 11, fontFamily: "Poppins",       fontWeight: 500, color: "#666666", align: "center" },
      company: { enabled: true,  x: 50, y: 54, size: 13, fontFamily: "Poppins",       fontWeight: 600, color: "#111111", align: "center" },
  ...
  },
  {
    ...
    elements: {
      orgName:    { enabled: true,  x: 50, y: 6,  size: 7,  fontFamily: "Poppins", fontWeight: 600, color: "#64748b", align: "center", transform: "uppercase", letterSpacing: 0.2 },
      eventTitle: { enabled: true,  x: 50, y: 14, size: 11, fontFamily: "Poppins", fontWeight: 700, color: "#1e3a8a", align: "center", transform: "uppercase", letterSpacing: 0.14 },
      eventDate:  { enabled: true,  x: 50, y: 22, size: 8,  fontFamily: "Poppins", fontWeight: 400, color: "#666666", align: "center" },
      name:       { enabled: true,  x: 50, y: 42, size: 22, fontFamily: "Poppins", fontWeight: 700, color: "#111111", align: "center" },
      company:    { enabled: true,  x: 50, y: 54, size: 12, fontFamily: "Poppins", fontWeight: 400, color: "#555555", align: "center" },
      ticket:     { enabled: true,  x: 50, y: 64, size: 8,  fontFamily: "Poppins", fontWeight: 700, color: "#1e3a8a", align: "center", transform: "uppercase", letterSpacing: 0.12 },
  ...
  },
  {
    ...
    elements: {
      orgName:    { enabled: true,  x: 50, y: 10, size: 8,  fontFamily: "Poppins",            fontWeight: 600, color: "#333333", align: "center", transform: "uppercase", letterSpacing: 0.2 },
  ...
  },
  {
    ...
    elements: {
      ...
      name:    { enabled: true,  x: 32, y: 38, size: 14, fontFamily: "Poppins", fontWeight: 700, color: "#111111", align: "center" },
      company: { enabled: true,  x: 32, y: 60, size: 9,  fontFamily: "Poppins", fontWeight: 400, color: "#555555", align: "center" },
  ...
  },
  {
    ...
    elements: {
      ...
      title:   { enabled: true,  x: 50, y: 56, size: 11, fontFamily: "Poppins",            fontWeight: 400, color: "#888888", align: "center", italic: true },
      company: { enabled: true,  x: 50, y: 64, size: 11, fontFamily: "Poppins",            fontWeight: 600, color: "#333333", align: "center" },
      qr:      { enabled: true,  x: 50, y: 84, size: 22 },
      email:   { enabled: false }, eventTitle: { enabled: false }, eventDate: { enabled: false }, orgName: { enabled: false }, customText: { enabled: false },
    },
  },
  {
    ...
    elements: {
      eventTitle: { enabled: true,  x: 50, y: 8,  size: 8,  fontFamily: "Poppins", fontWeight: 600, color: "#333333", align: "center", transform: "uppercase", letterSpacing: 0.14 },
      name:       { enabled: true,  x: 50, y: 28, size: 20, fontFamily: "Poppins", fontWeight: 800, color: "#000000", align: "center" },
      company:    { enabled: true,  x: 50, y: 40, size: 10, fontFamily: "Poppins", fontWeight: 400, color: "#555555", align: "center" },
      qr:         { enabled: true,  x: 50, y: 70, size: 32 },
      ticket:     { enabled: true,  x: 50, y: 92, size: 8,  fontFamily: "Poppins", fontWeight: 700, color: "#000000", align: "center", transform: "uppercase", letterSpacing: 0.12 },
